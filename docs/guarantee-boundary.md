...
| The EIP-712 signature uses a canonical low-s encoding and recovers the expected ECDSA address for the supplied domain and message | Whether that address is an EOA, or whether an ERC-1271/ERC-6492 smart-account signature is valid |
